...
const CACHE_NAME = 'novus-v9';
const CACHE_URLS = ['index.html', 'account.html', 'reflect.html', 'employer.html', 'college.html', 'offline.html', 'fouro4.html',
    'img/favicon.ico', 'img/icon_profile.svg', 'img/icon_reflect.svg', 'img/icon_employer.svg', 'img/icon_college.svg', 'img/citycampus_256x675.jpg', 'img/citycampus_256x675.webp',
    'img/android-chrome-192x192.png', 'img/android-chrome-512x512.png', 'img/apple-touch-icon.png', 'img/offlinemap.jpg',
    'manifest.json', 'collegecontacts.json', 'css/bootstrap.min.css', 'css/novus.css',
    'img/Crossten-ExtraLight.woff2', 'img/Crossten-ExtraBold.woff2',
    'js/jquery.min.js', 'js/script.js', 'js/account.js', 'js/auth.js', 'js/bootstrap.min.js', 'js/college.js', 'js/employer.js', 'js/firebase-init.js', 'js/firestore-init.js', 'js/reflect.js', 'js/signin.js'];
        ...
        caches.keys().then(function (cacheNames) {
            return Promise.all(
                cacheNames.map(function (cacheName) {
                    if (cacheName.startsWith('novus-') && CACHE_NAME !== cacheName) {
